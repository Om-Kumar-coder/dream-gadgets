...
const cmds = [
  `echo "=== ERROR LOG (last 80 lines) ===" && tail -80 /root/.pm2/logs/dream-gadgets-api-error.log`,
  `echo "=== OUT LOG (last 80 lines) ===" && tail -80 /root/.pm2/logs/dream-gadgets-api-out.log`,
];
