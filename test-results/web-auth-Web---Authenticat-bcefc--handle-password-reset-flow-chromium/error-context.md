...
- Name: web\auth.spec.ts >> Web - Authentication Flows >> should handle password reset flow
- Location: tests\e2e\web\auth.spec.ts:155:7
...
Call log:
  - waiting for locator('a:has-text("Forgot Password"), button:has-text("Forgot Password")')
