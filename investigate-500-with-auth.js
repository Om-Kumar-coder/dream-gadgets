...
const cmds = [
  'echo "=== GET TOKEN ===" && curl -s -X POST http://localhost:3000/api/v1/auth/login -H "Content-Type: application/json" -d \'{"identifier":"admin@test.com","password":"Admin@12345"}\' 2>&1',
];
