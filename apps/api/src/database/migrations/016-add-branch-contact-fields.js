export class AddBranchContactFields1700000000016 {
    constructor() {
        this.name = 'AddBranchContactFields1700000000016';
    }
    async up(queryRunner) {
        // Check if columns already exist (from earlier migration or manual add)
        const tableInfo = await queryRunner.query(`SELECT column_name FROM information_schema.columns WHERE table_name = 'branches'`);
...
//# sourceMappingURL=016-add-branch-contact-fields.js.map