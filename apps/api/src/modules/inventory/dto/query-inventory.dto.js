...
let QueryInventoryDto = (() => {
    ...
    return _a = class QueryInventoryDto {
            constructor() {
                ...
                this.condition = (__runInitializers(this, _limit_extraInitializers), __runInitializers(this, _condition_initializers, void 0));
                this.status = (__runInitializers(this, _condition_extraInitializers), __runInitializers(this, _status_initializers, void 0));
                ...
                this.branchId = (__runInitializers(this, _modelId_extraInitializers), __runInitializers(this, _branchId_initializers, void 0));
                this.minPrice = (__runInitializers(this, _branchId_extraInitializers), __runInitializers(this, _minPrice_initializers, void 0));
        ...
        (() => {
            ...
            _page_decorators = [ApiPropertyOptional({ default: 1 }), IsOptional(), IsNumber(), Min(1), Type(() => Number)];
            _limit_decorators = [ApiPropertyOptional({ default: 20 }), IsOptional(), IsNumber(), Min(1), Type(() => Number)];
            _condition_decorators = [ApiPropertyOptional(), IsOptional(), IsString()];
            _status_decorators = [ApiPropertyOptional(), IsOptional(), IsString()];
            _brandId_decorators = [ApiPropertyOptional(), IsOptional(), IsUUID()];
            _modelId_decorators = [ApiPropertyOptional(), IsOptional(), IsUUID()];
            _branchId_decorators = [ApiPropertyOptional(), IsOptional(), IsUUID()];
            _minPrice_decorators = [ApiPropertyOptional(), IsOptional(), IsNumber(), Min(0), Type(() => Number)];
            _maxPrice_decorators = [ApiPropertyOptional(), IsOptional(), IsNumber(), Min(0), Type(() => Number)];
