...
import { IsString, IsNumber, IsOptional, Min, IsEnum, Max } from 'class-validator';
...
let CreateAccessoryDto = (() => {
    ...
    return _a = class CreateAccessoryDto {
            constructor() {
                ...
                this.hsnCode = (__runInitializers(this, _reorderLevel_extraInitializers), __runInitializers(this, _hsnCode_initializers, void 0));
        ...
        (() => {
            ...
            _sku_decorators = [ApiProperty({ description: 'Unique SKU for the accessory' }), IsString()];
            _name_decorators = [ApiProperty({ description: 'Name of the accessory' }), IsString()];
            _description_decorators = [ApiPropertyOptional({ description: 'Description of the accessory' }), IsOptional(), IsString()];
            _brandId_decorators = [ApiPropertyOptional({ description: 'Brand ID (optional)' }), IsOptional(), IsString()];
            _modelId_decorators = [ApiPropertyOptional({ description: 'Model ID (optional)' }), IsOptional(), IsString()];
            _category_decorators = [ApiProperty({ description: 'Category of accessory' }), IsString(), IsEnum(ACCESSORY_CATEGORIES)];
            _purchasePrice_decorators = [ApiProperty({ description: 'Purchase price' }), IsNumber(), Min(0)];
            ...
            _stockQuantity_decorators = [ApiPropertyOptional({ description: 'Initial stock quantity' }), IsOptional(), IsNumber(), Min(0)];
            _reorderLevel_decorators = [ApiPropertyOptional({ description: 'Reorder level for low stock alert' }), IsOptional(), IsNumber(), Min(1)];
            _hsnCode_decorators = [ApiPropertyOptional({ description: 'HSN code for GST' }), IsOptional(), IsString()];
            _taxRate_decorators = [ApiPropertyOptional({ description: 'Tax rate percentage' }), IsOptional(), IsNumber(), Min(0), Max(100)];
            _notes_decorators = [ApiPropertyOptional({ description: 'Additional notes' }), IsOptional(), IsString()];
            _branchId_decorators = [ApiPropertyOptional({ description: 'Branch ID' }), IsOptional(), IsString()];
            _specs_decorators = [ApiPropertyOptional({ description: 'Specs as JSON object' }), IsOptional()];
            _photos_decorators = [ApiPropertyOptional({ description: 'Photos as JSON array' }), IsOptional()];
