...
let UpdateClientDto = (() => {
    var _a;
    let _classSuper = PartialType(CreateClientDto);
    let _isActive_decorators;
    let _isActive_initializers = [];
    let _isActive_extraInitializers = [];
    return _a = class UpdateClientDto extends _classSuper {
            constructor() {
                super(...arguments);
        ...
        (() => {
            ...
            _isActive_decorators = [ApiPropertyOptional(), IsOptional(), IsBoolean()];
