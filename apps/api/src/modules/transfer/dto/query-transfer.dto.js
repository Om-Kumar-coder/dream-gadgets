...
let QueryTransferDto = (() => {
    ...
    return _a = class QueryTransferDto {
            constructor() {
        ...
        (() => {
            ...
            _fromBranchId_decorators = [ApiPropertyOptional(), IsOptional(), IsString()];
            _toBranchId_decorators = [ApiPropertyOptional(), IsOptional(), IsString()];
            _status_decorators = [ApiPropertyOptional(), IsOptional(), IsIn(['draft', 'initiated', 'in_transit', 'received', 'rejected'])];
