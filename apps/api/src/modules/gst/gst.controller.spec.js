...
function makeMockService() {
    ...
    return {
        generateGstr1: jest.fn().mockResolvedValue({
            b2b: [
                {
        ...
        generateExcel: jest.fn().mockResolvedValue(Buffer.from(JSON.stringify({ message: 'mock_excel' }))),
    };
}
// ─── Test suite ───────────────────────────────────────────────────────────────
...
//# sourceMappingURL=gst.controller.spec.js.map