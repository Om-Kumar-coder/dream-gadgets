...
let Setting = (() => {
    ...
    var Setting = _classThis = class {
        constructor() {
            ...
            this.description = (__runInitializers(this, _value_extraInitializers), __runInitializers(this, _description_initializers, void 0));
            this.updatedById = (__runInitializers(this, _description_extraInitializers), __runInitializers(this, _updatedById_initializers, void 0));
    ...
    (() => {
        ...
        _key_decorators = [Column({ unique: true })];
        _value_decorators = [Column({ type: 'jsonb' })];
