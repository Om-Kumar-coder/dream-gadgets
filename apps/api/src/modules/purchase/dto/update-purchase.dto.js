...
let UpdatePurchaseDto = (() => {
    ...
    return _a = class UpdatePurchaseDto {
            constructor() {
                this.vendorName = __runInitializers(this, _vendorName_initializers, void 0);
                this.purchaseDate = (__runInitializers(this, _vendorName_extraInitializers), __runInitializers(this, _purchaseDate_initializers, void 0));
                this.taxAmount = (__runInitializers(this, _purchaseDate_extraInitializers), __runInitializers(this, _taxAmount_initializers, void 0));
        ...
        (() => {
            ...
            _purchaseDate_decorators = [ApiPropertyOptional(), IsOptional(), IsDateString()];
            _taxAmount_decorators = [ApiPropertyOptional(), IsOptional(), IsNumber(), Min(0)];
