...
let CreateExchangeDto = (() => {
    ...
    return _a = class CreateExchangeDto {
            constructor() {
                ...
                __runInitializers(this, _kycVerified_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _clientId_decorators = [ApiPropertyOptional(), IsOptional(), IsString()];
            _saleId_decorators = [ApiPropertyOptional(), IsOptional(), IsString()];
            _brandId_decorators = [ApiPropertyOptional(), IsOptional(), IsString()];
            _modelId_decorators = [ApiPropertyOptional(), IsOptional(), IsString()];
            _imei_decorators = [ApiPropertyOptional(), IsOptional(), IsString()];
            ...
            _batteryHealth_decorators = [ApiPropertyOptional(), IsOptional(), IsNumber(), Min(0), Max(100)];
            _conditionNotes_decorators = [ApiPropertyOptional(), IsOptional(), IsObject()];
            _exchangePrice_decorators = [ApiProperty(), IsNumber(), Min(0)];
            _photos_decorators = [ApiPropertyOptional(), IsOptional(), IsObject()];
            _kycVerified_decorators = [ApiPropertyOptional(), IsOptional(), IsBoolean()];
...
//# sourceMappingURL=create-exchange.dto.js.map