...
let ValidateCouponDto = (() => {
    ...
    return _a = class ValidateCouponDto {
            constructor() {
                ...
                this.subtotal = (__runInitializers(this, _code_extraInitializers), __runInitializers(this, _subtotal_initializers, void 0));
                this.userId = (__runInitializers(this, _subtotal_extraInitializers), __runInitializers(this, _userId_initializers, void 0));
                this.branchId = (__runInitializers(this, _userId_extraInitializers), __runInitializers(this, _branchId_initializers, void 0));
                __runInitializers(this, _branchId_extraInitializers);
            }
        },
        (() => {
            const _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _code_decorators = [ApiProperty({ description: 'Coupon code to validate' }), IsString(), MaxLength(50)];
            _subtotal_decorators = [ApiProperty({ description: 'Current cart subtotal' }), IsNumber(), Min(0)];
            _userId_decorators = [ApiPropertyOptional({ description: 'User ID (to check per-user limits)' }), IsOptional(), IsString()];
