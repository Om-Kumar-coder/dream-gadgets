...
export function PickupScheduler({ data, onUpdate }: PickupSchedulerProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-bold text-gray-900 mb-1">Schedule Free Pickup</h3>
        <p className="text-sm text-gray-500">Choose a convenient time for doorstep pickup</p>
      </div>
      ...
      {/* Confirmation note */}
      <div className="p-3 bg-emerald-50 rounded-xl text-xs text-emerald-700 flex items-start gap-2">
