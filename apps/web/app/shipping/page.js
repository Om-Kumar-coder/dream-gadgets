...
export default function ShippingPage() {
    return (_jsxs("main", { className: "animate-fade-in", children: [_jsx(BreadcrumbJsonLd, { items: [
                ...
                ] }), _jsx(JsonLd, { data: webPageSchema('Shipping Policy — Dream Gadgets', 'Dream Gadgets shipping policy — free shipping across India, delivery timeline, and order processing.', [
                    { name: 'Home', url: '/' },
                    { name: 'Shipping Policy', url: '/shipping' },
                ]) }), _jsxs("section", { className: "text-white py-16 px-4 text-center relative overflow-hidden bg-gradient-hero", children: [_jsx("div", { className: "absolute -top-16 -right-16 w-64 h-64 bg-primary/10 rounded-full blur-3xl pointer-events-none" }), _jsxs("div", { className: "relative", children: [_jsx("h1", { className: "text-4xl font-extrabold mb-3", children: "Shipping Policy" }), _jsx("p", { className: "text-white/60 text-sm", children: "Last updated: July 2026" })] })] }), _jsxs("section", { className: "max-w-3xl mx-auto px-4 py-12", children: [_jsxs("div", { className: "card p-5 mb-10", children: [_jsx("h2", { className: "text-sm font-bold text-surface-900 mb-3", children: "Table of Contents" }), _jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: SECTIONS.filter(s => !s.highlight && !s.contact).map((section) => (_jsx("a", { href: `#${section.id}`, className: "text-sm text-surface-600 hover:text-primary hover:underline", children: section.title }, section.id))) })] }), _jsx("div", { className: "space-y-10", children: SECTIONS.map((section) => {
                            if (section.highlight) {
                                return (_jsx("div", { className: "bg-blue-50 border border-blue-200 rounded-2xl p-6 text-center", children: _jsx("p", { className: "text-surface-800 leading-relaxed text-sm", children: section.content }) }, section.id));
                            }
                            if (section.contact) {
