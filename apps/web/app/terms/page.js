...
export default function TermsPage() {
    return (_jsxs("main", { className: "animate-fade-in", children: [_jsx(BreadcrumbJsonLd, { items: [
                ...
                ] }), _jsx(JsonLd, { data: webPageSchema('Terms & Conditions — Dream Gadgets', 'Terms and conditions for using Dream Gadgets services.', [
                    { name: 'Home', url: '/' },
                    { name: 'Terms & Conditions', url: '/terms' },
                ]) }), _jsxs("section", { className: "text-white py-16 px-4 text-center relative overflow-hidden bg-gradient-hero", children: [_jsx("div", { className: "absolute -top-16 -right-16 w-64 h-64 bg-primary/10 rounded-full blur-3xl pointer-events-none" }), _jsxs("div", { className: "relative", children: [_jsx("h1", { className: "text-4xl font-extrabold mb-3", children: "Terms & Conditions" }), _jsx("p", { className: "text-white/60 text-sm", children: "Last updated: January 2025" })] })] }), _jsxs("section", { className: "max-w-3xl mx-auto px-4 py-8", children: [_jsxs("div", { className: "card p-5 mb-10", children: [_jsx("h2", { className: "text-sm font-bold text-surface-900 mb-3", children: "Table of Contents" }), _jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-2", children: SECTIONS.map((section) => (_jsx("a", { href: `#${section.id}`, className: "text-sm text-surface-600 hover:text-primary hover:underline", children: section.title }, section.id))) })] }), _jsx("div", { className: "space-y-10", children: SECTIONS.map((section) => (_jsxs("div", { id: section.id, children: [_jsx("h2", { className: "heading-sm text-surface-900 mb-4", children: section.title }), _jsx("div", { className: "text-surface-600 leading-relaxed text-sm space-y-3 whitespace-pre-line", children: section.content.split('\n\n').filter(Boolean).map((para, i) => (_jsx("p", { children: para }, i))) })] }, section.id))) }), _jsx("div", { className: "divider mt-12 pt-8", children: _jsxs("div", { className: "grid grid-cols-2 sm:grid-cols-3 gap-3", children: [_jsx(Link, { href: "/privacy", className: "text-sm text-primary hover:underline font-medium", children: "Privacy Policy \u2192" }), _jsx(Link, { href: "/returns", className: "text-sm text-primary hover:underline font-medium", children: "Return & Refund Policy \u2192" }), _jsx(Link, { href: "/contact", className: "text-sm text-primary hover:underline font-medium", children: "Contact Us \u2192" })] }) })] })] }));
}
