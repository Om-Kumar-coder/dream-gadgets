...
const commands = [
  ...
  `echo '=== building api ==='; cd ${APP}/apps/api && npm run build 2>&1 | tail -8`,
  `echo '=== running migrations ==='; cd ${APP}/apps/api && node migrate.js 2>&1 | tail -12`,
  `echo '=== building web ==='; cd ${APP}/apps/web && npx next build 2>&1 | tail -10`,
